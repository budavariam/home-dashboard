...
export const ChartConfigSelector: React.FC<ChartConfigSelectorProps> = ({
    ...
    return (
        <div className={`flex flex-row flex-wrap items-center gap-x-4 gap-y-2 max-w-full ${className}`}>
            ...
            {showExtrapolation && (
                <div className="flex relative">
                    ...
                    {config.enableExtrapolation && (
                        <details className="absolute top-full right-0 mt-1 z-50 group">
                            ...
                            <div className="mt-1 p-3 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded shadow-lg w-80 max-w-[calc(100vw-2rem)]">
